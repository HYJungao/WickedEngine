...
namespace wi::enums
{
	...
	enum SHADERTYPE
	{
		...
		CSTYPE_DDGI_REMOTE_INDIRECT_DIFFUSE_FORMAL,
		...
		CSTYPE_YUV_TO_RGB_REGION,
		CSTYPE_RGB_TO_I420_ATLAS,
		CSTYPE_LIGHTING_DOWNSAMPLE_JOINT,
		CSTYPE_WETMAP_UPDATE,
		CSTYPE_DEPTH_REPROJECT,
		CSTYPE_DEPTH_PYRAMID,
		CSTYPE_LIGHTMAP_EXPAND,
		CSTYPE_LIGHTMAP_ADAPTIVE,
		CSTYPE_LIGHTMAP_LIGHTCANDIDATES,
