...
/* @@protoc_insertion_point(class_definition:webrtc.GrpcSignaling.SessionDescription) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SessionDescription* PROTOBUF_NONNULL other) {
...
/* @@protoc_insertion_point(class_definition:webrtc.GrpcSignaling.IceCandidate) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(IceCandidate* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
...
/* @@protoc_insertion_point(class_definition:webrtc.GrpcSignaling.SignalingMessage) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SignalingMessage* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
...
inline const ::webrtc::GrpcSignaling::SessionDescription& SignalingMessage::_internal_description() const {
  return Content_case() == kDescription ? static_cast<const ::webrtc::GrpcSignaling::SessionDescription&>(*_impl_.Content_.description_)
                     : reinterpret_cast<const ::webrtc::GrpcSignaling::SessionDescription&>(::webrtc::GrpcSignaling::_SessionDescription_default_instance_);
}
...
inline const ::webrtc::GrpcSignaling::IceCandidate& SignalingMessage::_internal_candidate() const {
  return Content_case() == kCandidate ? static_cast<const ::webrtc::GrpcSignaling::IceCandidate&>(*_impl_.Content_.candidate_)
                     : reinterpret_cast<const ::webrtc::GrpcSignaling::IceCandidate&>(::webrtc::GrpcSignaling::_IceCandidate_default_instance_);
}
