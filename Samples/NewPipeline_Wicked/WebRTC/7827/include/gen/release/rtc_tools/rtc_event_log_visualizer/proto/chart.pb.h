...
/* @@protoc_insertion_point(class_definition:webrtc.analytics.TickLabel) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(TickLabel* PROTOBUF_NONNULL other) {
...
/* @@protoc_insertion_point(class_definition:webrtc.analytics.DataSet) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(DataSet* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
...
/* @@protoc_insertion_point(class_definition:webrtc.analytics.Chart) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(Chart* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
...
/* @@protoc_insertion_point(class_definition:webrtc.analytics.ChartCollection) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ChartCollection* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
...
inline ::webrtc::analytics::DataSet* PROTOBUF_NONNULL Chart::add_data_sets()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::webrtc::analytics::DataSet* _add =
      _internal_mutable_data_sets()->InternalAddWithArena(
...
inline ::webrtc::analytics::TickLabel* PROTOBUF_NONNULL Chart::add_yaxis_tick_labels()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::webrtc::analytics::TickLabel* _add =
      _internal_mutable_yaxis_tick_labels()->InternalAddWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), GetArena());
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000002U);
...
inline ::webrtc::analytics::Chart* PROTOBUF_NONNULL ChartCollection::add_charts()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::webrtc::analytics::Chart* _add =
      _internal_mutable_charts()->InternalAddWithArena(
          ::google::protobuf::MessageLite::internal_visibility(), GetArena());
  SetHasBitForRepeated(_impl_._has_bits_[0], 0x00000001U);
