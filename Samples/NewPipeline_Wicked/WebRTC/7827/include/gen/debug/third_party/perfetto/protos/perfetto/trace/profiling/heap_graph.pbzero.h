...
class HeapGraph_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10> {
 public:
  ...
  bool has_heap_bytes_allocated() const { return at<10>().valid(); }
  int64_t heap_bytes_allocated() const { return at<10>().as_int64(); }
...
class HeapGraph : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    kPidFieldNumber = 1,
    kHeapBytesAllocatedFieldNumber = 10,
  ...
  using FieldMetadata_HeapBytesAllocated =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
  ...
  static constexpr FieldMetadata_HeapBytesAllocated kHeapBytesAllocated{};
  void set_heap_bytes_allocated(int64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_HeapBytesAllocated::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt64>
...
class HeapGraphObject_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/15> {
 public:
  ...
  bool has_application_info_long_version_code_field() const { return at<15>().valid(); }
  int64_t application_info_long_version_code_field() const { return at<15>().as_int64(); }
};
...
class HeapGraphObject : public ::protozero::Message {
 public:
  ...
  enum : int32_t {
    ...
    kApplicationInfoLongVersionCodeFieldFieldNumber = 15,
  };
  ...
  using FieldMetadata_ApplicationInfoLongVersionCodeField =
    ::protozero::proto_utils::FieldMetadata<
      15,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kInt64,
  ...
  static constexpr FieldMetadata_ApplicationInfoLongVersionCodeField kApplicationInfoLongVersionCodeField{};
  void set_application_info_long_version_code_field(int64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_ApplicationInfoLongVersionCodeField::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt64>
